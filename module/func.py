    ...
    try:
        message = TemplateSendMessage(
            ...
            template=ButtonsTemplate(
                thumbnail_image_url='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7022Cmi0lfveFaq108SEmW-YYoW-LF0cYBIRpmgUrVkP3wPjf&usqp=CAU',  #顯示的圖片
                title='按鈕樣版示範',  #主標題
                text='你要：',  #副標題
                actions=[
